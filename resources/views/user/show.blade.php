    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-6 text-end">
            <a href="/user/create" class="btn btn-primary btn-md"><i class="mdi mdi-account-plus"></i> Tambah User</a>
        </div>
      </div>
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-outline-warning btn-sm" href="{{ url('/user/'.$item->id.'/edit') }}">Edit</a>
                  ...
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              <p><strong>Nama Outlet:</strong>{{$item->outlet->nama}}</p>
